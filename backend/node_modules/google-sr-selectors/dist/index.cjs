...
__export(index_exports, {
  ...
  NewsSearchSelector: () => NewsSearchSelector,
  OrganicSearchSelector: () => OrganicSearchSelector,
  RelatedSearchesSelector: () => RelatedSearchesSelector,
  TimeSearchSelector: () => TimeSearchSelector,
  TranslateSearchSelector: () => TranslateSearchSelector,
  UnitConversionSelector: () => UnitConversionSelector
});
...
var RelatedSearchesSelector = {
  query_item: "a.ZWRArf",
  // Each related query link
  text: "span.fYyStc"
  // Visible query string inside the <a>
};
